...
public class AdbNetworkPreferenceController extends DeveloperOptionsPreferenceController implements
    ...
    private boolean isAdbEnabled() {
        ...
        return Settings.Global.getInt(cr, Settings.Global.GZOSP_ADB_PORT, ADB_NETWORK_SETTING_OFF)
                != ADB_NETWORK_SETTING_OFF;
    }

    protected void writeAdbSetting(boolean enabled) {
        Settings.Global.putInt(mContext.getContentResolver(),
                Settings.Global.GZOSP_ADB_PORT, enabled ? ADB_NETWORK_SETTING_ON : ADB_NETWORK_SETTING_OFF);
